...
export default function MMScreen() {
  ...
  const dynamicStyles = {
    ...
    chipActiveBg: isDark ? "#3B82F6" : "#1E3A8A",
  };
    ...
    <ScreenContainer
      ...
      headerComponent={
        <>
          ...
          <Text style={[s.subtitle, { color: isCloture ? "#EF4444" : "#10B981" }]}>
        ...
        {(["transactions", "matin", "soir", "cloture"] as const).map((t) => (
          ...
          >
            <Text style={[s.tabText, tab === t && s.tabTextActive]}>
              {t === "transactions" ? "📋 Tx" : t === "matin" ? "🌅 Matin" : t === "soir" ? "🌆 Soir" : "🔒 Fin"}
            </Text>
          </TouchableOpacity>
        ))}
      </View>
                ...
                {operateurs.map((op) => (
                  <TouchableOpacity
                    ...
                    style={[
                      s.chip,
                      form.operateur === op
                        ? [s.chipActive, { backgroundColor: dynamicStyles.chipActiveBg }]
                  ...
                  >
                    <Text
                      style={[
                        s.chipText,
                        form.operateur === op ? s.chipTextActive : { color: dynamicStyles.textMain },
                      ]}
                    >
                      {op}
                    </Text>
              ...
              <View style={s.typeRow}>
                ...
                >
                  <Text
                    style={[
                      s.typeText,
                      form.type === "depot" ? { color: "#FFF" } : { color: dynamicStyles.textMain },
                    ]}
                  >
                    📥 Dépôt
                  </Text>
                ...
                >
                  <Text
                    style={[
                      s.typeText,
                      form.type === "retrait" ? { color: "#FFF" } : { color: dynamicStyles.textMain },
                    ]}
                  >
                    📤 Retrait
                  </Text>
            ...
            transactions.map((tx: any) => (
              ...
              >
                ...
                <View style={{ flex: 1, paddingLeft: 4 }}>
                  ...
                  {tx.client_nom ? (
                    <Text style={{ fontSize: 11, color: dynamicStyles.textSub }}>
                      {tx.client_nom}
                    </Text>
                  ) : null}
                </View>
